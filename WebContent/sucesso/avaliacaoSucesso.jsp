...
<%
    ...
    <div align="center">
    	<h3 class="text-muted">
    		Avaliação Cadastrado com Sucesso!
    	</h3>
    ...
    <div class="container">
    	...
    	<div align="center">
    	<p> 
    		Código Da Avaliação gerado:<h1>${codigo}</h1>
    	</p>
    	<div>	
		<div align="center">
			<a class="btn btn-lg btn-success mesmo-tamanho"
				href="menuPrincipal.jsp" role="button">
					Voltar para o Menu Principal
			</a>
			<a class="btn btn-lg btn-success mesmo-tamanho"
				href="cadastroAvaliacao.jsp" role="button">
				Cadastrar Outra Avalição 
			</a>
		</div>
	</div>
	</div>
